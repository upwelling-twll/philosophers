...
/*   Updated: 2024/07/09 17:47:34 by nmagdano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//routine_philo.c
int				philo_routine(t_phlst *p, t_param *sd,
...
int				someone_is_dead(t_param *shared_data,
					pthread_mutex_t *sd_mutex);
...
int				taking_forks(t_phlst *p, t_param *sd,
					pthread_mutex_t *sd_mutex);
